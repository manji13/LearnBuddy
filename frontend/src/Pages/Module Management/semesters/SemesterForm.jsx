  ...
  return (
    <div className="max-w-lg">
      <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
        ...
        <span>/</span>
        <span className="text-gray-700">{isEdit ? 'Edit Semester' : 'New Semester'}</span>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <select className={fieldCls} value={form.faculty} onChange={set('faculty')}>
          ...
          <div className="flex gap-3 pt-1">
            ...
            <Link to={isEdit ? `/semesters/${id}` : '/semesters'} className="inline-flex items-center px-4 py-2 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors shadow-sm">
              Cancel
            </Link>
          </div>
        </form>
