  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center gap-2 text-sm text-gray-400 mb-6 flex-wrap">
        ...
        <span>/</span>
        <Link to={`/faculties/${semester.faculty?._id}`} className="hover:text-blue-600 transition-colors">{semester.faculty?.name}</Link>
        <span>/</span>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Faculty: <Link to={`/faculties/${semester.faculty?._id}`} className="text-blue-600 hover:underline">{semester.faculty?.name}</Link>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <Link to="/modules/new" className="px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 rounded-lg shadow-sm transition-colors">+ Add Module</Link>
      </div>
