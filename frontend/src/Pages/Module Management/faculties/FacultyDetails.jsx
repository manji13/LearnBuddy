...
export default function FacultyDetail() {
  ...
  if (!faculty) return <p className="text-gray-500 p-8">Faculty not found.</p>
      ...
      <div className="flex">
        ...
        <main className="ml-56 flex-1 p-8">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {/* ✅ Passes facultyId as query param so SemesterForm auto-selects this faculty */}
            <Link
              to={`/semesters/new?facultyId=${id}`}
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            {semesters.length === 0 ? (
              <div className="flex flex-col items-center py-10 gap-2 text-center">
                ...
                <Link to={`/semesters/new?facultyId=${id}`} className="text-xs text-blue-600 hover:underline mt-1">
