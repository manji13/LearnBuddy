      ...
      <main className="max-w-7xl mx-auto p-6 sm:p-8">
        <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 mt-4 relative overflow-hidden">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
             <div
               className="h-48 bg-gradient-to-br from-indigo-50 to-white rounded-2xl border border-indigo-100 flex flex-col items-center justify-center text-indigo-600 font-bold shadow-sm hover:shadow-md transition-shadow cursor-pointer"
               onClick={() => navigate('/notes-ai')}
             >
             ...
             <div
               className="h-48 bg-gradient-to-br from-teal-50 to-white rounded-2xl border border-teal-100 flex flex-col items-center justify-center text-teal-600 font-bold shadow-sm hover:shadow-md transition-shadow cursor-pointer"
