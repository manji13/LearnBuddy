...
const UserProfile = () => {
  ...
  return (
    // Added py-8 md:py-12 to give the whole page breathing room
    <div className="min-h-screen bg-slate-50 font-sans py-8 md:py-12">
      
      {/* Added max-w-6xl mx-auto to center everything, and items-start to fix stretching */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row gap-8 items-start w-full relative">
        
        {/* Left Sidebar Area - CRITICAL FIX: Added md:sticky md:top-12 z-10 to lock it on scroll */}
        ...
        <main className="flex-1 w-full">
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden w-full max-w-3xl mx-auto">
            ...
            <div className="p-8 pt-0 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="pt-4">
                  <button type="submit" disabled={message.type === 'loading'} className="w-full bg-[#1e293b] text-white font-extrabold py-3.5 px-6 rounded-xl shadow-lg hover:bg-indigo-600 hover:shadow-indigo-200 hover:shadow-2xl transform transition-all active:scale-[0.98] text-sm disabled:opacity-70 disabled:cursor-not-allowed">
                    Save Changes
                  </button>
                </div>
              </form>
