...
const StudentNavbar = () => {
  ...
  return (
    <nav className="w-full backdrop-blur-md bg-white/70 px-6 py-2.5 flex justify-between items-center sticky top-0 z-50 border-b border-white/20 shadow-lg">
      ...
      >
        <img src={logo} alt="LearnBuddy" className="w-10 h-10 rounded-full border-2 border-white/50 shadow-md group-hover:border-indigo-300 transition-all duration-200 object-cover" />
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-full left-0 mt-1 w-44 backdrop-blur-md bg-white/90 shadow-xl rounded-xl border border-white/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col overflow-hidden">
            <Link to="/student/faculties" className="px-4 py-3 text-sm font-medium text-slate-600 hover:bg-indigo-50/80 hover:text-indigo-600 hover:pl-5 transition-all duration-200 cursor-pointer border-b border-white/20">
              All Faculties
            </Link>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute top-full left-0 mt-1 w-52 backdrop-blur-md bg-white/90 shadow-xl rounded-xl border border-white/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col overflow-hidden">
            <Link to="/ai/note-summaries" className="px-4 py-3 text-sm font-medium text-slate-600 hover:bg-teal-50/80 hover:text-teal-600 hover:pl-5 transition-all duration-200 cursor-pointer border-b border-white/20">Note Summaries</Link>
            <Link to="/ai/resources-finder" className="px-4 py-3 text-sm font-medium text-slate-600 hover:bg-teal-50/80 hover:text-teal-600 hover:pl-5 transition-all duration-200 cursor-pointer border-b border-white/20">Resources Finder</Link>
            <Link to="/ai/qa-generator" className="px-4 py-3 text-sm font-medium text-slate-600 hover:bg-teal-50/80 hover:text-teal-600 hover:pl-5 transition-all duration-200 cursor-pointer border-b border-white/20">Q&A Generator</Link>
      ...
      <div className="flex items-center gap-3 border-l border-white/20 pl-4 sm:pl-6">
        ...
        >
          {profileImage && profileImage !== 'undefined' ? (
            <img src={profileImage} alt="Profile" className="w-10 h-10 rounded-full object-cover border-2 border-white/50 group-hover:border-indigo-500 group-hover:shadow-md transition-all duration-200" />
          ) : (
